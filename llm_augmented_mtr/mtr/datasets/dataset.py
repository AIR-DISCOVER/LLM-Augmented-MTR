...
class DatasetTemplate(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, training=True, logger=None, dataset_type=""):
        super().__init__()
    ...
    def mode(self):
        if self.dataset_type == "":
            ...
            assert self.dataset_type == "train" or self.dataset_type == "valid" or self.dataset_type == "test", \
