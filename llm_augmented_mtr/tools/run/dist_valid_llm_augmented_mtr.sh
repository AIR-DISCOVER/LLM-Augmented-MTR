...
--ckpt ../output/waymo/mtr+100_percent_data_llm_augmented/llm_augmented_mtr+100_percent/ckpt/checkpoint_epoch_1.pth \
--batch_size 20 \
--extra_tag valid_mtr+100_percent_llm_augmented \
--dataset_type valid
