...
def parse_config():
    ...
    parser.add_argument('--dataset_type', choices=["train", "valid", "test"], default="", type=str, help="tell the dataloader we need which part of the dataset")
...
def main():
    ...
    cfg.MODEL.MOTION_DECODER.LOAD_CONTEXT_DATA = cfg.DATA_CONFIG.LOAD_CONTEXT_DATA
    cfg.MODEL.GENERATE_EMBEDDING = cfg.DATA_CONFIG.GENERATE_EMBEDDING
    load_context_data = cfg.DATA_CONFIG.LOAD_CONTEXT_DATA
    if load_context_data:
        cfg.MODEL.MOTION_DECODER.RETRIEVAL_WINDOW_SIZE = cfg.DATA_CONFIG.RETRIEVAL_WINDOW_SIZE
    ...
    # output_dir = Path("/data15/zhengxj/projects/mtr_storage") / 'output' / cfg.EXP_GROUP_PATH / cfg.TAG / args.extra_tag
    ...
    test_set, test_loader, sampler = build_dataloader(
        dataset_cfg=cfg.DATA_CONFIG,
        batch_size=args.batch_size,
        dist=dist_train, workers=args.workers, logger=logger, training=False, dataset_type="valid"
    )
